...
def calculate_reward(execution_time, memory_usage):
    # Reward based on execution time (lower time is better)
    time_reward = -execution_time  # Negative time to encourage faster execution
    
    # Reward based on memory usage (lower memory is better)
    memory_reward = -memory_usage  # Negative memory to encourage lower memory use
    
    total_reward = time_reward + memory_reward  # Combined reward
    return total_reward
